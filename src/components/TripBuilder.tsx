  ...
  return (
    <section className="py-16 px-4 max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row gap-8 items-stretch">
        {/* Left Side Image */}
        <div className="lg:w-90% rounded-[30px] overflow-hidden hidden lg:block">
          <div
            className="h-full w-full bg-cover bg-center"
            style={{
              backgroundImage:
                "url('https://raw.githubusercontent.com/CSSamarasinghe/Tripmate_web/main/src/assets/trip-planner.jpg')",
              height: "100%",
              minHeight: "600px",
            }}
          >
            <div className="h-full flex flex-col justify-end p-8 bg-gradient-to-t from-black/80 via-black/30 to-transparent">
              <div className="text-white">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  Plan Your Perfect Trip
                </h2>
                <p className="text-lg max-w-xl">
                  Tell us your preferences and we'll create a personalized
